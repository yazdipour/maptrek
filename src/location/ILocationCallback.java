...
public interface ILocationCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILocationCallback {
        private static final String DESCRIPTOR = "mobi.maptrek.location.ILocationCallback";
        static final int TRANSACTION_onGpsStatusChanged = 2;
    ...
    void onGpsStatusChanged() throws RemoteException;

    void onLocationChanged() throws RemoteException;
}
